@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Sistema Vinculacion')])

@section('content')
<div class="container" style="height: auto;">
    <div class="row align-items-center">
        <div class="col-md-9 ml-auto mr-auto mb-3 text-center">
            <h3>{{ __('Login primero por favor.') }}</h3>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="bmd-form-group{{ $errors->has('username') ? ' has-danger' : '' }}">
                            <div class="input-group">
                                ...
                                <input type="text" name="username" class="form-control" placeholder="{{ __('Usuario o Email...') }}"
